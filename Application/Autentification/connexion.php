...
var_dump($password);
    ...
    $query1 = "SELECT * FROM `restaurant` WHERE email='$email'  and deleted =0";
  ...
  // recuperation type restaurant 
    $query1 = "SELECT * FROM `client` WHERE email='$email' and deleted =0";
    $result1 = mysqli_query($conn,$query1) ;
  ...
  $query2 = "SELECT * FROM `admin` WHERE login='$email' and deleted =0";
