            ...
            <div class="col-sm-5 text-center">
                <div class="row text-white" style ="margin-top: 35px;">
                    ...
                    <div class="col-sm-2 text-left">
                        ...
                        <?php 
                        $resu = mysqli_fetch_array(mysqli_query($conn, "SELECT count(*) FROM notification n,Envoyer e, client  c,restaurant r WHERE e.id_restau = r.id_restau AND e.id_notif = n.id_notif AND e.id_client = c.id_client AND e.id_client = '$id_client' AND e.date_envoi='$today'
...
$REQ=mysqli_query($conn, "SELECT n.objet , e.date_envoi , r.nom FROM notification n,Envoyer e, client  c,restaurant r WHERE e.id_restau = r.id_restau AND e.id_notif = n.id_notif AND e.id_client = c.id_client AND e.id_client = '$id_client' AND  e.date_envoi ='$today' 
                    ...
                    <div class="col-sm-4 col-md-5  col-4 text-center">
                        ...
                        <div class="dropdown  mb-3 ">
                            ...
                            <ul class="dropdown-menu" style="width: 350px;  background-color: (6, 92, 103, 0.809);">
                                        ...
                                        <img src="../image/<?= $r['url']?>" alt="" width="15%" height="20%" style=" margin-left:35%; border-radius: 100%;" class=" text-center">
