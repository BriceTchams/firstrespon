                    ...
                    <div class="col-sm-7" >
                        ...
                        border-radius: 10px;">
                            ...
                            <div class="col-sm-3 col-md-3 ">
                                ...
                                <h4 style="color: rgb(228, 244, 133); " class="text-center">Quantité</h4>
                                    ...
                                    <span class="d-flex justify-content-center my-4">    
                                        <a href="./panierVitrine.php?id2=<?= $row['id_plat']?>" class="page-link">
                                            <i class="fa-solid fa-circle-minus text-white  fa-2x "></i>
                                        </a>
                                        <h4 class="mx-3"> <?=  $_SESSION['panier'][$row['id_plat']] ?></h4> 
                                        <a href="./panierVitrine.php?id1=<?= $row['id_plat']?>" class="page-link">
                            ...
                            <div class="col-sm-1 col-md-1">
                                <a href="./panierVitrine.php?id=<?= $row['id_plat']?>" style="margin-top: 40%; margin-right: 15%;" class="page-link"><i class="fa-solid fa-trash fa-2x text-danger" ></i>   </a>              
                           </div>
                     ...
                     <div class="col-sm-5 col-md-5 col-12 text-left">
                        ...
                        <div class="card mt-5  bg-dark" style="width: 100%; margin-top: 15%; margin-bottom: 30%;">
                            ...
                            <div class="card-footer" style="border: none; background-color:;">
                                <button class="btn my-4 bg-light" style="width: 70%; font-size: 25px; margin-left: 15%;
                                border-radius: 60px;" data-bs-toggle="modal" data-bs-target="#myModal1">
