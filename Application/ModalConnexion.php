            ...
            <div class="modal-body">
              <form action="./Autentification/connexion.php" class="form mx-3 " Method="POST" >
               ...
               <div class="form-floating mt-4">
                  <input type="text" class="form-control" name= "email" required id="floatingPassword" placeholder="Email" style="border-radius: 70px; background-color: rgb(217, 217, 217);">
