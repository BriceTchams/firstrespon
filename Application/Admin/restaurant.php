            ...
            background-size:100% 100%;" -->
                 ...
                 <div class="row " style="margin-top:5%;">
                            ...
                            <div class="row " >
                                ...
                                <H3 class="text-center mt-4 mb-3"> <strong>LISTE DES RESTAURANTS</strong>  </H3>
                                
                                <button class="btn   my-4 bg-dark text-white mx-5 " style="
                                height: 60px; border-radius: 15px; width: 20%; " data-bs-toggle="modal" data-bs-target="#myModal1"><h5>Ajouter un restaurant</h5> </button>
                            <br>
                            </div>
                                ...
                                <table   id="maTable" class=" table table-striped table-bordered table-responsive"  style="width: 100%;  " >
                                    <thead class="border-1 ">
                                        <tr class="">
                                                ...
                                                <th class="text-center" ><strong class="">Mot de passe</strong></th>
                        ...
                        $sql="SELECT DISTINCT * FROM restaurant ";
                                    ...
                                    <tr class="text-center"  >
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <form action="./deleteclient.php" method="post">
                                                <input type="hidden" value="<?= $ligne['id_restau'] ?>" 
                                                name="idrestau">
                                               
                                                <button type="submit" class="" name="btndelete1"> <i class="fa-solid fa-trash-can text-danger "> </i> 
                                                    </button>
...
if(isset($_POST['btnmodif'])){
    ...
    $row = mysqli_fetch_assoc(mysqli_query($conn , "SELECT DISTINCT * FROM restaurant WHERE id_restau = '$id'"));
...
>
          ...
          <input type="hidden" value="<?= $row['id_restau']?>" name="id">      
...
<div class="form-floating mt-4">
 ...
 <div class="form-floating mt-3">
    <input type="text" name="password" class="form-control" id="floatingPassword" placeholder="Mot de passe" style="border-radius: 70px; background-color: rgb(217, 217, 217);" required value="<?= $row['mot_de_passe']?>">
...
<div class="form-floating mt-3">
    <input type="file" name="image" class="form-control" id="image" placeholder="image" style="border-radius: 70px; background-color: rgb(217, 217, 217);">
 ...
 <button type="button" id="monboutton" class="bg-danger from-control"style="width: 20%; border-radius:60px ;  background-color: rgb(2, 156, 177); height: 50px;">Annuler</button>
   ...
   <input type="submit" value="Modifier" name = "soumettre1"
