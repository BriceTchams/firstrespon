        ...
        <div class="modal-dialog">
          <div class="modal-content bg-white">
            ...
            <div class="modal-header ">
              <h3 class="text-center  text-dark " style="margin-left:30%;"><strong>Nouveau restaurant</strong></h3>
            ...
            <div class="modal-body">
                <form action="./insert.php" class="form mx-3 " method = "post" enctype="multipart/form-data" >
                  ...
                  ?>
                    <div class="form-floating mt-4">
                        <input type="text" class="form-control" id="pays"  name="pays" placeholder="pays" style="border-radius: 70px; background-color: rgb(217, 217, 217);" required>
