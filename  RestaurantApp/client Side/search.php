...
<?php  
              ...
              $date = date('y-m-d');
              $requette1 = "SELECT DISTINCT r.id_restau , r.url , r.nom , r.ville , p.libelle , p.pu , p.url_photo, p.id_plat FROM restaurant r , plat p
              WHERE p.id_restau = r.id_restau  AND deleted='0' AND p.libelle='$input' ";
