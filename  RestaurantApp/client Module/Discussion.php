            ...
            background-size:100% 100%;" -->
                 ...
                 <div class="card mt-5" style=" width:70%; margin-left:15%; border-radius:11px; " >
                    <div class="card-header">  <div class="bg-light mt-2 text-center" style="height: 50px; width:100%; border-radius:10px;">
                                <strong><h2 class="my-3 mx-4">Nouvelle notification</h2></strong>
                  </div>
                 <div class="card-body">
                    <form action="./ajouterNotification.php" class="form  text-center" Method="POST" style="width:70%; margin-left:15%; border-radius:20px; "  enctype="multipart/form-data">
                                    <!-- <p class="mt-4 h3 text-center"> </p> -->
                       


                        <div class="form-floating mt-4">
                        <input type="text" class="form-control " name= "objet" required id="Objet" placeholder="Objet" style="border-radius: 70px; background-color: rgb(217, 217, 217);">
                        ...
                        $sql="SELECT DISTINCT c.id_client ,c.nom , c.prenom FROM plat p , restaurant r , Ligne_commande l , client c  , commande cm
                    ...
                    <!-- deuxieme input  -->
                        ...
                        <select name="idclient" id="nom" class="form-control" style="border-radius: 70px; background-color: rgb(217, 217, 217); height:70px;"
                        data-tags="true" data-placeholder="client" data-allow-clear="true">
                            <?php while($ligne = mysqli_fetch_assoc($answer)){ ?>
                                <option value="<?= $ligne['id_client']?>"><?= $ligne['nom']?> <?= $ligne['prenom']?></option>
