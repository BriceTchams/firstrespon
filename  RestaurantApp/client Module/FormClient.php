        ...
        <div class="modal-dialog">
          <div class="modal-content bg-white">
            ...
            <div class="modal-header ">
              <h3 class="text-center  text-dark " style="margin-left:30%;"><strong>Nouveau client</strong></h3>
              <!-- <button type="button" class="btn-close" data-bs-dismiss="modal"></button> -->
            </div>
      
            <!-- Modal body -->
            <div class="modal-body">
                <form action="" class="form mx-3 " method = "post" enctype="multipart/form-data" >
